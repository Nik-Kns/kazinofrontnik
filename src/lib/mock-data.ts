...
export const segmentsData: SegmentData[] = [
  { id: '1', name: 'Новые игроки (без депозита)', description: 'Пользователи, зарегистрировавшиеся за последние 7 дней и не совершившие ни одного депозита.', playerCount: 1820, createdAt: '2024-07-01', createdBy: 'AI', growthChurn30d: 12.8, avgDeposit: 0, runRateToTarget: 0 },
  { id: '2', name: 'VIP-игроки', description: 'Игроки с Lifetime Revenue > €5,000 и последней активностью не позднее 30 дней назад.', playerCount: 520, createdAt: '2024-06-28', createdBy: 'Пользователь', growthChurn30d: -3.2, avgDeposit: 680, runRateToTarget: 82 },
  { id: '3', name: 'Риск оттока (предиктивный)', description: 'Игроки с Churn Probability Score > 75% и снижением частоты сессий на 50% за последние 14 дней.', playerCount: 740, createdAt: '2024-07-03', createdBy: 'AI', growthChurn30d: -14.5, avgDeposit: 92, runRateToTarget: 38 },
  { id: '4', name: 'Сделали первый депозит', description: 'Игроки, которые совершили свой первый депозит за последний месяц.', playerCount: 2540, createdAt: '2024-06-15', createdBy: 'Пользователь', growthChurn30d: 9.6, avgDeposit: 135, runRateToTarget: 71 },
  { id: '5', name: 'Спящие (30+ дней)', description: 'Игроки, не заходившие в игру более 30 дней, но имеющие хотя бы 1 депозит в истории.', playerCount: 620, createdAt: '2024-05-20', createdBy: 'Пользователь', growthChurn30d: -19.3, avgDeposit: 82, runRateToTarget: 28 },
  { id: '6', name: 'Любители слотов', description: 'Игроки, у которых 80% игрового времени приходится на слоты.', playerCount: 7200, createdAt: '2024-07-04', createdBy: 'AI', growthChurn30d: 10.8, avgDeposit: 152, runRateToTarget: 88 },
];
